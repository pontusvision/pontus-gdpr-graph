 ...
 */
public
class ConcurrentProperties extends Properties
{
   ...
   * @serial
   */
  protected ConcurrentProperties defaults;
  protected ConcurrentHashMap<Object,Object> cprop ;
   ...
   */
  public ConcurrentProperties(ConcurrentProperties defaults) {
  ...
  public synchronized Object setProperty(String key, String value) {
    return ((ConcurrentHashMap) concurrentHashMap).put(key, value);
  }
  ...
  public synchronized void load(Reader reader) throws IOException {
    load0(new ConcurrentProperties.LineReader(reader));
  }
  ...
  public synchronized void load(InputStream inStream) throws IOException {
    load0(new ConcurrentProperties.LineReader(inStream));
  }

  private void load0 (ConcurrentProperties.LineReader lr) throws IOException {
    ...
    while ((limit = lr.readLine()) >= 0) {
      ...
      ((ConcurrentHashMap) concurrentHashMap).put(key, value);
    }
  }
      ...
      throws IOException
  {
    ...
    bw.newLine();
    synchronized (this) {
      for (Enumeration<?> e = ((ConcurrentHashMap) concurrentHashMap).keys(); e.hasMoreElements();) {
        String key = (String)e.nextElement();
        String val = (String)((ConcurrentHashMap) concurrentHashMap).get(key);
  ...
  {
    ConcurrentProperties.XmlSupport.load(this, Objects.requireNonNull(in));
    in.close();
  }
  ...
  public void storeToXML(OutputStream os, String comment, String encoding)
      throws IOException
  {
    ConcurrentProperties.XmlSupport.save(this, Objects.requireNonNull(os), comment,
  ...
  public String getProperty(String key) {
    Object oval = concurrentHashMap.get(key);
   ...
   * @see     ConcurrentProperties#defaults
  ...
  private synchronized void enumerate(Hashtable<String,Object> h) {
    ...
    for (Enumeration<?> e = ((ConcurrentHashMap) concurrentHashMap).keys(); e.hasMoreElements() ;) {
      String key = (String)e.nextElement();
      h.put(key, ((ConcurrentHashMap) concurrentHashMap).get(key));
    }
  }
  ...
  private synchronized void enumerateStringProperties(Hashtable<String, String> h) {
    ...
    for (Enumeration<?> e = ((ConcurrentHashMap) concurrentHashMap).keys(); e.hasMoreElements() ;) {
      ...
      Object v = ((ConcurrentHashMap) concurrentHashMap).get(k);
  ...
  private static class XmlSupport {
    ...
    static void load(ConcurrentProperties props, InputStream in)
        throws IOException, InvalidPropertiesFormatException
    {
      PROVIDER.load(props, in);
    }

    static void save(ConcurrentProperties props, OutputStream os, String comment,
                     String encoding)
        throws IOException
    {

...
public class App
{
  ...
  public static Graph initGraph(String confFile)
  {
    ...
    try
    {
      ...
      PropertyKey metadataOwner = mgmt.makePropertyKey("Metadata.Owner").dataType(String.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey metadataLineage = mgmt.makePropertyKey("Metadata.Lineage").dataType(String.class)
          .cardinality(Cardinality.SET).make();
      PropertyKey metadataRedaction = mgmt.makePropertyKey("Metadata.Redaction").dataType(String.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey metadataVersion = mgmt.makePropertyKey("Metadata.Version").dataType(Integer.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey metadataCreateDate = mgmt.makePropertyKey("Metadata.CreateDate").dataType(Date.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey metadataUpdateDate = mgmt.makePropertyKey("Metadata.UpdateDate").dataType(Date.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey metadataStatus = mgmt.makePropertyKey("Metadata.Status").dataType(String.class)
          .cardinality(Cardinality.SET).make();
      PropertyKey metadataOrigId = mgmt.makePropertyKey("Metadata.OrigId").dataType(UUID.class)
          .cardinality(Cardinality.SINGLE).make();
      ...
      PropertyKey partyOrgRegNumber = mgmt.makePropertyKey("Party.Org.RegNumber").dataType(String.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey partyOrgType = mgmt.makePropertyKey("Party.Org.Type").dataType(String.class)
          .cardinality(Cardinality.SET).make();
      PropertyKey partyOrgName = mgmt.makePropertyKey("Party.Org.Name").dataType(String.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey partyOrgShortName = mgmt.makePropertyKey("Party.Org.ShortName").dataType(String.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey partyOrgTaxId = mgmt.makePropertyKey("Party.Org.TaxId").dataType(String.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey partyOrgSector = mgmt.makePropertyKey("Party.Org.Sector").dataType(String.class)
          .cardinality(Cardinality.SET).make();
      ...
      PropertyKey objectCredentialUsername = mgmt.makePropertyKey("Object.Credential.Username").dataType(String.class)
          .cardinality(Cardinality.SINGLE).make();
      PropertyKey objectCredentialQuestions = mgmt.makePropertyKey("Object.Credential.Questions").dataType(String.class)
          .cardinality(Cardinality.SET).make();
      PropertyKey objectCredentialAnswers = mgmt.makePropertyKey("Object.Credential.Answers").dataType(String.class)
          .cardinality(Cardinality.SET).make();
      ...
      mgmt.buildIndex("nameAndAge", Vertex.class).addKey(partyPersonFullName).addKey(partyPersonDateOfBirth)
